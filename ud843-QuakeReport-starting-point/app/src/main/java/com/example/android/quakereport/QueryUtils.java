...
/**
 * Created by Vismaya on 11-Feb-18.
 */
    ...
    public static ArrayList<word> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i = 0; i < jsonArray.length(); i++ ) {
                JSONObject feaJSONObj = jsonArray.getJSONObject(i);
                JSONObject proJSONObj = feaJSONObj.getJSONObject("properties");

                Double mag = proJSONObj.optDouble("mag");
                String place = proJSONObj.optString("place");
                long time = proJSONObj.optInt("time");
                String url = proJSONObj.optString("url");
